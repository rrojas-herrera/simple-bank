...
Tipo de dato compuesto que te permite agrupar varios campos (variables) bajo un mismo nombre.
Es parecido a un “objeto” en otros lenguajes como JavaScript o una “clase” sin métodos en Java o C++.
```go
type Persona struct {
    Nombre string
    Edad   int
